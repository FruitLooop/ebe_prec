...
class ebe_prec:
    ...
    def get_element_diag(self, gl_diag_scaler_inv, size, cell_id):
        n_c = size
    ...
    def precon(self, data, diag, gl_inv_diag):
        ...
        for i in range(len(data)):
            ...
            diag_inv = self.get_element_diag( gl_inv_diag,kc.shape[0], data_pos)
            term1 = kc - dc
...
chol = C.precon(data, data_diag, C.get_inv_dia())
chol_T = chol.T
